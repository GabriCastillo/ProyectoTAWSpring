...
<html>
    ...
    <body>
        ...
        <header>
            <ul>
  <li><a class="active" href='/Iniciado/<%=user.getIdusuario()%>'>Home</a></li>
  <li><a href="VenderServlet">Mis Subastas</a></li>
  <li><a href='/Misproductos/<%=user.getIdusuario()%>'>Mis Productos</a></li>
  <li><a href='/Misfavoritos/<%=user.getIdusuario()%>'>Mis Productos Favoritos</a></li>
  ...
  <li style="float:right"><a href="PerfilServlet"><%= user.getNombre() %></a></li>
    ...
    <form method="post" action='/Iniciado/filtrar/<%=user.getIdusuario()%>'>
    ...
    <div class="box" id="subastas" >
            ...
            <div style="display:flex;margin-top: 20px;margin-bottom: 20px">
                ...
                <div style="text-align: center;width:20%;margin-top: 50px">
                    ...
                    %>
                    <form action='/Iniciado/pujar/<%=user.getIdusuario()%>' method="post"  >
                    ...
                    if(esta!=false){ 
                    %>
                    <form action='/Iniciado/QuitarFavorito/<%=subasta.getIdcompra()%>/<%=user.getIdusuario()%>' method="post">
                    ...
                    %>
                    <form action='/Iniciado/Favorito/<%=subasta.getIdcompra()%>/<%=user.getIdusuario()%>' method="post">
                    <button type="submit" id="btn"  value="Añadir favorito" >Añadir a Favoritos</button>
                    </form>
                    <%
                        }
                    }
