...
<%@ page import="es.taw.proyecto.entity.Lista" %>
<%@ page import="es.taw.proyecto.dto.UsuarioDTO" %>
<%@ page import="es.taw.proyecto.entity.Categoria" %>
...
<table border="1">
    ...
    <%
        ...
        List<Lista> listaUnificada = new ArrayList();
        ...
        for (Lista lista : listaUnificada) {
    %>
    <tr>
...
<table border="1">
    ...
    <%
        List<Categoria> ultimasCategorias = (List) request.getAttribute("ultimasCategorias");
