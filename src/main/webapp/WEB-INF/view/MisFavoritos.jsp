...
<html>
    ...
    <form method="post" action='/Misfavoritos/filtrar/<%=user.getIdusuario()%>'>
        ...
        <section>
            ...
            <div style="display:flex;margin-top: 20px;margin-bottom: 20px">
                ...
                <div style="text-align: center;width:20%;margin-top: 50px">
                    ...
                    if(subasta.getPrecioCompra()==0){
                    %>
                    <form action='/Misfavoritos/QuitarFavorito/<%=subasta.getIdcompra()%>/<%=user.getIdusuario()%>' method="post">
                    ...
                    %>
                   <form action='/Misfavoritos/pujar/<%=user.getIdusuario()%>' method="post"  >
